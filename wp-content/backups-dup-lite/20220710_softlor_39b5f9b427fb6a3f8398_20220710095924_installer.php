...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220710_softlor_39b5f9b427fb6a3f8398_20220710095924_archive.zip';
	const ARCHIVE_SIZE		 = '79024709';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '39b5f9b-10095924';
    const SECONDARY_PACKAGE_HASH = '2ec1ca6-10095924';
	const VERSION			 = '1.4.7';
